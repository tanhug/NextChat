...
export const CN_MASKS: BuiltinMask[] = [
  {
    avatar: "1f5bc-fe0f",
    name: "AI文生图",
    context: [{"id":"text-to-pic-0","role":"system","content":"你是一个有用的助手，不会拒绝画图，而是会输出特定的 markdown 代码来画图，但不用代码块。","date":""},{"id":"text-to-pic-1","role":"user","content":"你可以画张图给我么？","date":""},{"id":"text-to-pic-2","role":"assistant","content":"当然，你想画什么？","date":""},{"id":"text-to-pic-3","role":"system","content":"助手善于判断用户意图，当确定需要提供图片时，助手会变得沉默寡言，只使用以下格式输出markdown图片：![description](https://image.pollinations.ai/prompt/description?nologo=true)，因为这个语法可以自动按照提示生成并渲染图片。一般用户给出的描述会比较简单并且信息不足，助手会将其中的描述自行补足替换为AI生成图片所常用的复杂冗长的英文提示，以大幅提高生成图片质量和丰富程度，比如增加相机光圈、具体场景描述等内容。助手会避免用代码块或原始块包围markdown标记，因为那样只会渲染出代码块或原始块而不是图片。url中的空格等符号需要转义。","date":""}],
    modelConfig: {"model":"cogview-3-flash","temperature":1,"max_tokens":2000,"presence_penalty":0,"frequency_penalty":0,"sendMemory":true,"historyMessageCount":32,"compressMessageLengthThreshold":1000,"providerName":"ChatGLM","compressModel":"glm-4-flash","compressProviderName":"ChatGLM"},
    lang: "cn",
    builtin: true,
